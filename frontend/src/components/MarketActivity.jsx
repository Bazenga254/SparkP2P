      ...
      <div className="panel">
        ...
        {err ? <div className="empty-line" style={{ color: '#ff6b6b' }}>{err}</div> : !data ? <div className="empty-line">Loading market activity…</div> : (
          <>
            ...
            <div className="footnote">“Bought” = USDT filled on the merchant's buy ads (the reliable signal we rank by). “Sold” = what they've disposed of — Bought minus what they still have listed for sale (Avail Now), capped at Bought — since raw sell-ad churn over-states real selling; a merchant with offline clients keeps a visible Bought↔Sold gap, one who sells only on Binance closes it. Our own merchants show their exact real-time sold. “Est. traded” = Bought + Sold. “Avail Now” = USDT they currently have listed for sale — their largest single sell ad (so a split/spoof two-ad post can't inflate it). It updates in real time as they sell or restock, and holds the last known value (dimmed) while a merchant's ads are switched off. “Net Spread” = their live posted sell price minus buy price, minus Binance fees for their tier (Gold 0.25 / Silver 0.35 / Bronze 0.40 KES/USDT) — their net margin per USDT after fees, shown only when the merchant is quoting both sides of the book.</div>
          </>
        )}
      </div>
