        ...
        <div className="land-section-inner">
          ...
          <div className="land-download-grid">
            <div className="land-download-card">
              ...
              <h3>Windows</h3>
              <p>Windows 10 / 11</p>
              <a href="https://github.com/Bazenga254/SparkP2P/releases/download/v1.1.0/SparkP2P.Setup.1.1.0.exe" className="land-download-btn" target="_blank" rel="noreferrer">Download .exe</a>
            </div>
            <div className="land-download-card">
              <div className="land-download-icon">
          ...
          <div style={{ textAlign: 'center', marginTop: 24, maxWidth: 520, margin: '24px auto 0' }}>
            <p style={{ color: '#6b7280', fontSize: 13 }}>
              v1.1.0 &middot; Auto-updates enabled &middot; Requires Google Chrome installed
            </p>
